...
export const CHART_LEGEND_SETTINGS = {
  visible: true,
  textStyle: { fontFamily: CHART_FONT_FAMILY },
};

export const ACCUMULATION_LEGEND_SETTINGS = {
  visible: true,
  textStyle: { fontFamily: CHART_FONT_FAMILY },
};

export const HIDDEN_LEGEND_SETTINGS = { visible: false };

export const COLUMN_WIDTH = 0.6;
export const COLUMN_CORNER_RADIUS = { topLeft: 6, topRight: 6 };

export const CHART_SELECTION_MODE = 'Point';
export const CHART_HIGHLIGHT_MODE = 'Point';
